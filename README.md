...
Create a shared-experience repo on your git host (GitHub, TGit, CNB, or GitLab), **grant write access to team members**, then have them run `teamai init https://github.com/yourorg/yourrepo`.
